...
(function (global) {
  ...
  function inject() {
    ...
    if (document.body.classList.contains("product-page") || document.body.classList.contains("offers-page") || document.body.classList.contains("shipping-page") || document.body.classList.contains("factories-page")) {
  ...
  (function () {
    ...
    if (cats.length) {
      ...
      if (bar) {
        ...
        bar.innerHTML = html;
        if (window.SFCategoryScroll) SFCategoryScroll.mount(bar);
      }
    }
