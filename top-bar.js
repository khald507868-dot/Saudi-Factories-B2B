    ...
    if (cats.length) {
      ...
      function setupCatScroll(box) {
        ...
        function autoMove(now) {
          ...
          /* جهة واحدة بطلب المالك: كان يعكس الاتجاه عند
             الطرف فيرتدّ راجعاً، وهو ما وصفه بــ«يتحرك في
             جهتين». فصار يعود إلى البداية ويكمل بنفس الجهة.

             والعودة قفزة واحدة لا انزلاق: الحلقة المتّصلة
             تحتاج تكرار الفئات مرّتين، وذلك يفسد maxScroll
             ومنطق الأسهم وقفزة النقر معاً. */
